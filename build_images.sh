...
(cat Dockerfile-dev-base; cat dev-ruby) | docker build --build-arg='RUBY_VERSION=2.5.1' -t tool2/dev-ruby:2.5.1-$BUILD_VERSION -
docker push tool2/dev-ruby:2.5.1-$BUILD_VERSION
